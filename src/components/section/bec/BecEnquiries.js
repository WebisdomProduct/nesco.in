...
function BecEnquiries() {
  return (
    <section className="relative bg-[#ffb71b] w-full min-h-[300px] lg:min-h-[400px]">
      ...
      <div className="hidden lg:block">
        ...
        <div className="absolute left-0 top-0 bottom-0 right-2/3 bg-white">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-3 bg-[#ffb71b]"></div>
          ...
          <div className="pl-12 pr-8 py-12 h-full flex flex-col justify-center">
            ...
            <div className="space-y-6">
              <div className="flex items-center text-gray-600">
                ...
                <span className="text-lg font-medium">contact@bombayexhibitioncenter.in</span>
              </div>
              
              <div className="flex items-center text-gray-600">
                <MdPhone className="w-5 h-5 mr-4 text-gray-400" />
                <span className="text-lg font-medium">022 66450123</span>
              </div>
            </div>
          </div>
        </div>
