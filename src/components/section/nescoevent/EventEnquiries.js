        ...
        <div className="py-8 px-8 sm:px-10 md:px-12">
          ...
          <div className="space-y-3 sm:space-y-5">
            <div className="flex items-center text-gray-600">
              ...
              <span className="text-base sm:text-lg text-gray-500">events@nesco.co.in</span>
            </div>
            
            <div className="flex items-center text-gray-600">
              <MdPhone className="w-5 h-5 mr-4 text-gray-500" />
              <span className="text-base sm:text-lg text-gray-500">+91 99099 44444</span>
            </div>
          </div>
        </div>
      </div>
