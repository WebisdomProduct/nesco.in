...
function SocialEducation() {
  ...
  const SliderData = [
    {
      title1: "J. V. Patel Industrial Training Institute,",
      title2: "Karamsad, Gujarat.",
      name: "J. V. Patel Industrial Training Institute,",
      position: "Karamsad, Gujarat.",
      link: "",
      bImage: "https://nesco.in/assets/images/about-us/csr/powering-education/csr-trust-1.jpg",
      description:
        "The J. V. Patel Industrial Training Institute was set up in Karamsad on August 15, 1979. The country still had a long way to go in terms of vocational training. Total employment would just be a dream if private players were reluctant to step in. J. V. Patel himself knew of the deprivations that befell the economically weak and that education was one among them. Karamsad had a large population of youth that were waiting to be active instruments to the nation. By donating five acres of private land, this Government-recognised institute began training hundreds of technicians in different trades. Over decades, new trades have been introduced and existing trades have been upgraded. Today, our graduates are given first preference by many manufacturers and multinationals in India, who vie with each other to be the year’s top recruiter.",
    },
    {
      title1: "C. J. Patel Ladies Hostel,",
      title2: "Vallabh Vidyanagar, Gujarat.",
      name: "C. J. Patel Ladies Hostel,",
      position: "Vallabh Vidyanagar, Gujarat.",
      link: "",
      bImage: "https://nesco.in/assets/images/about-us/csr/powering-education/csr-trust-2.jpg",
      description:
    ...
    {
      title1: "C. J. Patel English Medium School,",
      title2: "Karamsad, Gujarat.",
      name: "C. J. Patel English Medium School,",
      position: "Karamsad, Gujarat.",
      link: "",
      bImage: "https://nesco.in/assets/images/about-us/csr/powering-education/csr-trust-3.jpg",
      description:
    ...
    {
      title1: "Sumant Jethabhai Patel English Medium School,",
      title2: "Karamsad, Gujarat.",
      name: "Sumant Jethabhai Patel English Medium School,",
      position: "Karamsad, Gujarat.",
      link: "",
      bImage: "https://nesco.in/assets/images/about-us/csr/powering-education/csr-trust-4.jpg",
      description:
    ...
    {
      title1: "Sumant Jethabhai Patel English Medium School,",
      title2: "Tarapur, Gujarat",
      name: "Sumant Jethabhai Patel English Medium School,",
      position: "Tarapur, Gujarat",
      link: "",
      bImage: "https://nesco.in/assets/images/about-us/csr/powering-education/csr-trust-5.jpg",
      description:
    ...
    {
      title1: "Supporting Local Trusts",
      title2: "",
      name: "Supporting Local Trusts",
      position: "",
      link: "",
      bImage: "https://nesco.in/assets/images/about-us/csr/powering-education/csr-trust-6.jpg",
      description:
    ...
    },
    {
      ...
      position: "",
      link: "",
      bImage: "https://nesco.in/assets/images/about-us/csr/powering-education/csr-trust-7.jpg",
      description:
    ...
    {
      title1: "Sardar Patel Memorial and Trust,",
      title2: "Karamsad, Gujarat.",
      name: "Sardar Patel Memorial and Trust,",
      position: "Karamsad, Gujarat.",
      link: "",
      bImage: "https://nesco.in/assets/images/about-us/csr/powering-education/csr-trust-8.jpg",
      description:
