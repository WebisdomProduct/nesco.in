    ...
    <section className="header_white flex justify-between items-center w-full bg-[#403092] relative pt-16 xl:pt-14 overflow-hidden xl:h-auto 2xl:h-screen lg:h-screen h-full ">
      <div className="px-[5%] ">
        <div className="flex flex-col xl:w-[50%] md:gap-7 gap-10 md:py-20 pb-20 z-10">
          ...
          <p
            className="text-[48px] font-bold text-secondary mt-10 tracking-wide leading-[3.5rem]"
        ...
        <div className="hidden xl:flex absolute w-full h-full top-0 left-0 lg:justify-center lg:items-center overflow-hidden">
          <img
            src={background.src}
            alt="background"
            className="absolute z-0 xl:w-[60%] w-[50%] -right-5 top-0"
          />
          <div className="absolute hidden lg:block z-0 xl:bottom-20 bottom-10 right-8
           h-[33%] w-[140px]">
            <div
