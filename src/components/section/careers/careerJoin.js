...
function CareerJoin() {
  ...
  return (
    <section className="w-full flex justify-center flex-col items-center md:py-20 py-14 font-branding-medium">
      <div className="relative z-10 flex flex-col items-center w-[85%] md:gap-10 gap-8">
        <h2
