...
function PhilosophyForUs() {
  ...
  // useEffect(() => {
  //   gsap.fromTo("", { opacity: 0 }, { opacity: 1, duration: 2, repeat: -1 });
  // }, []);
  ...
  //       >
  //         <div className="leading-0 rotate-[-138deg] w-[80%] relative mt-12">
  //           <Image
  //             src={images[i]}
  //             alt="B letter"
  ...
  //   <div className={ `letterAnimation text-[30rem] text-white flex justify-center items-center`}>
  //     <div className="leading-0 rotate-[-138deg] w-[80%] relative mt-12">
  //       <Image
  //         key={index}
  //         src={image}
    ...
    <div className="bg-[#0F0E9F] flex flex-col justify-center items-center">
      <div className="h-screen w-full text-white xl:text-[6rem] lg:text-[5rem] md:text-[4rem] sm:text-[3rem] text-[2rem] leading-[6rem] text-center font-branding-semibold flex flex-col justify-center items-center relative">
        <div className="w-full h-full relative flex justify-center items-center">
          <div className="relative w-[76rem] h-[34rem] flex justify-center items-center">
            {/* Top Line */}
            ...
            {/* Bottom Line */}
            <div className="line-bottom absolute bottom-0 left-[57%] w-[57%] h-3 bg-[#00B7F1] rounded-full transform origin-left rotate-180"></div>

            {/* Left Line */}
            <div className="line-left absolute top-[100%] -left-2 w-3 h-[47rem] bg-[#00B7F1] rounded-full transform origin-top rotate-[225deg]"></div>
          </div>
        </div>
      ...
      <div className="h-screen relative w-full flex flex-col">
        <div className="bg-[#00B7F1] w-[2000px] h-[1000px] rotate-[136deg] absolute -bottom-1/2 transform translate-x-[9.3%]"></div>
        <div className=" w-full leading-0 h-full justify-center items-center flex  absolute">
          <div
            className={`letterAnimation text-[30rem] text-white flex justify-center items-center`}
          >
        ...
        <div className="relative w-full h-full flex justify-center items-center">
          <p className="text-[#00B7F1] w-72 text-right left-[10%] top-[20%] text-2xl font-branding-semibold absolute">
          ...
          <div className="text-white w-[27rem] right-[7%] flex flex-col gap-10 top-[35%] text-base absolute">
            <p>
