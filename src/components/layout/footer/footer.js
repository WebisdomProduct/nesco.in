...
function Footer() {
  ...
  return (
    <div className=" bg-[#081422] text-white flex flex-col justify-center items-center font-branding-medium pt-7 pb-2 z-50 relative ">
      <div className="w-[90%] xl:flex footer_section">
