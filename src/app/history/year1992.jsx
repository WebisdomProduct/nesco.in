...
const Year1992 = () => {
  ...
  return (
    <motion.div
      ...
      className="year1992 min-h-screen flex flex-col justify-center p-6 md:ml-6"
        ...
        >
          <div className="contentDiv flex flex-col relative gap-4 bg-[#001F9C] p-12 sm:left-0 md:left-[15%] lg:left-[20%]  transition-shadow duration-300 hover:shadow-lg hover:shadow-blue-500/50">
            ...
            <motion.div
              ...
              className="iconDiv relative  flex w-full sm:w-[70%] md:w-[70%] lg:w-[50%]  sm:left-0 left-4"
            >
              <Image
                src={historyEleven}
                alt="Icon"
            ...
            <motion.div
              ...
              className="bottomText flex relative sm:w-full md:w-[80%] left-0 sm:left-0 p-2"
            >
