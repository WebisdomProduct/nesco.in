...
const Year1952 = () => {
  ...
  return (
    <motion.div
      ...
      className="1952Div min-h-screen w-full max-w-[1200px] mx-auto relative p-4 md:flex md:flex-row justify-center items-center transition-all ease-in-out duration-300 hover:translate-y-1 md:left-10"
      data-year="1952"
