...
const Year1964 = () => {
      ...
      const interval = setInterval(() => {
        setCount((prevCount) => {
          ...
          if (nextCount >= 1964) {
            ...
            return 1964; // Stop exactly at 1964
          }
          return nextCount;
        });
  ...
  return (
    <motion.div
      ...
      className="year1964 min-h-screen flex flex-col justify-center p-6 md:ml-6"
    ...
    >
      <div className="container flex flex-col sm:flex-col md:flex-row lg:flex-row relative m-auto mt-4 mb-4  p-4">
        ...
        >
          <div className="contentDiv flex flex-col relative gap-4 bg-cyan-400 p-12 sm:left-0 md:left-[15%] lg:left-[20%] transition-shadow duration-300 hover:shadow-lg hover:shadow-cyan-400/50">
            {/* Year Heading */}
            <motion.p
              initial={{ opacity: 0, y: -20 }}
              animate={year1964InView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.6, delay: 0.5 }}
              className=" h-fit w-fit relative text-6xl md:text-7xl lg:text-9xl font-branding-bold text-blue-700 left-2 sm:left-0  sm:top-0 m-2"
            >
              {count}
              <motion.div
